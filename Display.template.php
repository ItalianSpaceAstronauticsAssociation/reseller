...
function template_main()
{
	...
	while ($message = $context['get_message']())
	{
		...
		{
			/* MIKE AVATAR ASTRONAUTINEWS 
			//echo "$message['member']['username']";
			if($message['member']['name']=="astronauticast")
			{
				echo'
							<li class="avatar">
								<a href="', $scripturl, '?action=profile;u=', $message['member']['id'], '">
									<img src="',$settings['images_url'] ,'/astronauticast.png" /> 
								</a>
							</li>';
				...
				if ($message['can_approve'] || $context['can_reply'] || $message['can_modify'] || $message['can_remove'] || $context['can_split'] || $context['can_restore_msg'])
					echo '				
										<div class="btn-group navbar-right">
											<button type="button" class="btn btn-primary dropdown-toggle btn-sm" data-toggle="dropdown">Azioni <span class="caret"></span></button>
