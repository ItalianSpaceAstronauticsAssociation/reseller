...
<head>
	...
	<link rel="shortcut icon" href="http://www.forumastronautico.it/images/favicon.ico" type="image/ico">
		...
		<footer>
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-12">
						Reseller by <a href="http://smftricks.com" style="color:#FFFFFF" target="_blank">Daniiel</a>. Designed by <a  style="color:#FFFFFF"  target="_blank" href="http://briancasillas.url.ph">Brian</a>. Modified by <a  style="color:#FFFFFF"  target="_blank" href="http://www.signal-eleven.com">Michael</a> and the ISAA Tech Team
					</div>
					<div class="col-lg-12">
...
echo' <!-- Mike aggiunto codice Google -->
        ...
        <script type="text/javascript">
                try {
                var pageTracker = _gat._getTracker("UA-11356659-4");
